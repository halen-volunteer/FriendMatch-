...
export const getAdminUserReportContext = (reportId) => request.get(`/api/report/admin/user/${reportId}/context`)
...
export const getAdminTeamReportContext = (reportId) => request.get(`/api/report/admin/team/${reportId}/context`)
