...
export const updateMemberRoleCompat = (data) => request.post('/api/team/member/role', data)
export const transferLeader = (data) => request.post('/api/team/transfer-leader', data)
export const transferCaptainCompat = (data) => request.post('/api/team/transfer-captain', data)
