...
const navItems = computed(() => {
  const isReviewer = authStore.adminName === 'reviewer'

  return [
    { path: '/admin/dashboard', icon: Grid, label: '总览', visible: true },
    { path: '/admin/reports', icon: User, label: '用户举报', visible: !isReviewer },
    ...
    { path: '/admin/punish', icon: Warning, label: '处罚中心', visible: !isReviewer },
