    ...
    <template v-else>
      <div class="stats-grid">
        ...
        <el-card class="metric-card">
          ...
          <span class="metric-extra">来源于队伍分页接口总数。</span>
        </el-card>
        ...
        <el-card class="metric-card">
          ...
          <span class="metric-extra">统计用户举报和队伍举报中的待处理数据。</span>
        </el-card>
        ...
        <el-card class="metric-card">
          ...
          <span class="metric-extra">帮助管理员及时处理处罚申诉。</span>
        </el-card>
      </div>
          ...
          <div v-else class="stack-list">
            <article v-for="item in stats.recentReports" :key="item.id" class="activity-item">
              <div class="compact-meta">
                ...
                <el-tag size="small" :type="getStatusType(item.status)">状态 {{ item.status }}</el-tag>
              </div>
